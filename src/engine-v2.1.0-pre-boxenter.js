...
(function (root, factory) {
  ...
  Engine.prototype._step = function (dir) {
    ...
    for (var k2 = 0; k2 < order.length; k2++) {
      var isSelfLoop = (chain[order[k2]].type === '0B' && String(chain[order[k2]].spaceId) === String(this.current.spaceId));
      var res = this._tryEnter(chain[order[k2]], dir, { chainLen: chain.length, boxType: chain[order[k2]].type, selfLoop: isSelfLoop });
      if (res) return true;
    }
